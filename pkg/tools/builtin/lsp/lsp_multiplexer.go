...
// Multiplexer combines multiple LSP backends into a single toolset.
...
// Backend pairs a raw Tool (used for file-type routing) with an
...
func (m *Multiplexer) Kind() string { return "LSP" }
